                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown me-2">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="..//partials/login/adminlogin.php"><i
                                        class="fas fa-user-shield me-2"></i>Admin</a></li>
                            <li><a class="dropdown-item" href="..//partials/login/login.php"><i
                                        class="fas fa-user-graduate me-2"></i>Student</a></li>
                            <li><a class="dropdown-item" href="..//partials/login/tlogin.php"><i
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="partials/register/sregister.php"><i
                                        class="fas fa-user-graduate me-2"></i>Student</a></li>
                            <li><a class="dropdown-item" href="partials/register/tregister.php"><i
                                        class="fas fa-chalkboard-teacher me-2"></i>Teacher</a></li>
                        </ul>
                    </li>
                </ul>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-2 col-md-4">
                    ...
                    <ul class="list-unstyled small">
                        ...
                        <li class="mb-2"><a href="..//about.php" class="text-white text-decoration-none">About Us</a>
                        </li>
                        <li class="mb-2"><a href="..//gallery.php" class="text-white text-decoration-none">Gallery</a>
                        </li>
