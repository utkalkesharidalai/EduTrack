...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark  sticky-top shadow-sm" style="background-color: #0c111a;">
        ...
        <a class="navbar-brand fw-bold" href="index.html">
                <img src="../images/h_logo.png" alt="EduTrack Logo" height="40" class="me-2">
            </a>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown me-2">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="adminlogin.php"><i class="fas fa-user-shield me-2 active"></i>Admin</a></li>
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="card shadow p-4 login-card" style="width: 100%; max-width: 400px;">
            ...
            <div class="text-center mb-4">
                <!-- Logo -->
                <img src="images/h_logo.png" alt="Logo" height="50" class="mb-2">
